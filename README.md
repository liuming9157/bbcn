...
<p align="center">
  BBCN是Budibase的中文版本，由JackLiu翻译并维护，采用完全开源的模式。目前已完成了文档翻译及应用汉化，后续将增加微信登陆、小程序SaaS等本土化功能。如果你也愿意贡献自己的力量或者捐赠，欢迎联系<a href="https://github.com/liuming9157/bbcn-doc">Jack Liu</a>
</p>
<h3 align="center">
  在您自己的设施上快速构建应用
</h3>
